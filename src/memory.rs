...
use crate::{callbacks::Callbacks, colony::Colonies, creeps::{CreepData, Creeps, fabricator::FabricatorCoordinator, truck::TruckCoordinator}, messages::Messages, movement::{Movement, MovementClosed}, safeid::{TryMakeSafe, UnsafeIDs}};
...
pub struct Memory {
    ...
    pub movement: Movement<MovementClosed>
}
